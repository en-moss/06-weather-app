        ...
        response.json()
            .then (function(data) {
                ...
                if (curWeather >= 200 && curWeather <= 232) {
                    weatherToday.setAttribute('src', './Assets/thunder.png')
                } else if (curWeather >= 500 && curWeather <= 531) {
                    weatherToday.setAttribute('src', './Assets/rain.png')
                } else if (curWeather >= 600 && curWeather <= 622) {
                    weatherToday.setAttribute('src', './Assets/snow.png')
                } else if (curWeather >= 701 && curWeather <= 781) {
                    weatherToday.setAttribute('src', './Assets/mist.png')
                } else if (curWeather == 800) {
                    weatherToday.setAttribute('src', './Assets/clear.png')
                } else if (curWeather >= 801 && curWeather <= 802) {
                    weatherToday.setAttribute('src', './Assets/few-clouds.png')
                } else {
                    weatherToday.setAttribute('src', './Assets/clouds.png')
                }
                ...
                function popDays() {
                    for (var i = 0; i < 4; i++) {
                        ...
                        if (dayWeatherArr[i] >= 200 && dayWeatherArr[i] <= 232) {
                            weatherDay.setAttribute('src', './Assets/thunder.png')
                        } else if (dayWeatherArr[i] >= 500 && dayWeatherArr[i] <= 531) {
                            weatherDay.setAttribute('src', './Assets/rain.png')
                        } else if (dayWeatherArr[i] >= 600 && dayWeatherArr[i] <= 622) {
                            weatherDay.setAttribute('src', './Assets/snow.png')
                        } else if (dayWeatherArr[i] >= 701 && dayWeatherArr[i] <= 781) {
                            weatherDay.setAttribute('src', './Assets/mist.png')
                        } else if (dayWeatherArr[i] == 800) {
                            weatherDay.setAttribute('src', './Assets/clear.png')
                        } else if (dayWeatherArr[i] >= 801 && dayWeatherArr[i] <= 802) {
                            weatherDay.setAttribute('src', './Assets/few-clouds.png')
                        } else {
                            weatherDay.setAttribute('src', './Assets/clouds.png')
                        }
                    }
                }
                popDays();
